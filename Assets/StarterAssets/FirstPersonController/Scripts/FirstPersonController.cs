...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            gunShootParticles = gun.GetComponent<ParticleSystem>();
        ...
        /// <summary>
        /// just shoots straight forwards from the player character
        /// </summary>
        private void Shoot()
        {
            if (_input.shoot)
            {
                ...
                if (_input.shoot && Time.time > lastFireTime + fireRate)
                {
                    ...
                    if (Physics.Raycast(_mainCamera.transform.position, _mainCamera.transform.forward, out hit, range))
                    {
                        ...
                        // GameObject bulletTrail = Instantiate(this.bulletTrail).GetComponent<GameObject>();
